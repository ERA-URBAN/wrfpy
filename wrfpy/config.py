...
class config:
    ...
    def _create_empty_config(self):
        ...
        '''
        # define keys
        keys_dir = ['wrf_dir', 'wrf_run_dir', 'wrfda_dir', 'upp_dir',
                    'wps_dir', 'archive_dir', 'boundary_dir',
                    'upp_archive_dir', 'work_dir']
        keys_wrf = ['namelist.input']
        keys_upp = ['upp', 'upp_interval']
        keys_wrfda = ['namelist.wrfda', 'wrfda', 'wrfda_type', 'cv_type',
                      'be.dat']
        keys_general = ['date_start', 'date_end', 'boundary_interval',
                        'ref_lon', 'ref_lat']
...
>>> Please edit the configuration file before continuing.''' % self.configfile
    ...
    def _check_wrfda_dir(self):
        ...
        assert os.path.isdir(self.config['filesystem']['wrfda_dir']), (
            'wrfda directory %s not found' % self.config['filesystem'][
                                                         'wrfda_dir'])
    ...
    def _check_upp_dir(self):
        assert os.path.isdir(self.config['filesystem']['upp_dir']), (
            'upp directory %s not found' % self.config['filesystem'][
                                                       'upp_dir'])
        # create list of files to check
        files_to_check = [
    ...
    def _check_wps(self):
        ...
        # check if namelist.wps is in required format and has all keys needed
    ...
    def _check_wrf(self):
        ...
        # check if namelist.input is in required format and has all keys needed
